 ...
 * 
 * Note that a {@link NodeWithNumber} can live it at most one
 * {@link NumberedGraph} at a time. The {@link NumberedGraph} will mutate the
 * number here. So this is a bit fragile. Use this only if you know what you're
 * doing.
 */
