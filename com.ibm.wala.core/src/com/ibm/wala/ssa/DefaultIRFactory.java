 ...
 * 
 * This creates {@link IR} objects from Shrike methods, and directly from
 * synthetic methods.
 */
public class DefaultIRFactory implements IRFactory<IMethod> {
   ...
   * com.ibm.wala.ipa.callgraph.Context, com.ibm.wala.ipa.cha.IClassHierarchy,
   ...
   * com.ibm.wala.ipa.callgraph.Context, com.ibm.wala.ipa.cha.IClassHierarchy,
   * com.ibm.wala.ssa.SSAOptions, com.ibm.wala.util.warnings.WarningSet)
   */
  ...
  /**
   * Is the {@link Context} irrelevant as to structure of the {@link IR} for a
   * particular {@link IMethod}?
   */
